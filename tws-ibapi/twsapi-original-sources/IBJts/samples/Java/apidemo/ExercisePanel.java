	...
	class ExPanel extends VerticalPanel {
		...
		void onExercise() {
			...
			if (i != -1 && account != null) {
				...
				ApiDemo.INSTANCE.controller().exerciseOption(account, position.contract(), m_combo.getSelectedItem(), m_qty.getInt(), m_override.isSelected(), manualOrderTime, customerAccount);
			}
		}
	}
